            ...
            this.resultsDiv.html(`
                ...
                return `
                    ...
                    <div class="one-third">
                        ...
                        ${(results.programs.length) ? `<ul class="link-list mi-list">
                ...
                return `
                        ...
                        </ul>` : `<p>No programs for this search</p><a href="${globalObject.root_url}"> View All Programs</a>`}
                        <h2 class="search-overlay__section-title">Professors</h2>
                    </div>
                    <div class="one-third">
                        <h2 class="search-overlay__section-title">Campuses</h2>
                        ${(results.campuses.length) ? `<ul class="link-list mi-list">
                ...
                return `
                        ...
                        </ul>` : `<p>No Campuses for this search</p><a href="${globalObject.root_url}"> View All Campuses</a>`}
