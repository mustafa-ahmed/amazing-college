            ...
            <div class="site-header__menu group">
                ...
                <div class="site-header__util">
                    ...
                    if (is_user_logged_in()) { ?>
                        ...
                        <a href="<?php esc_url(site_url('/my-notes'));  ?>" class="btn btn--small btn--orange float-left push-right"><?php echo print_r(!is_user_logged_in()); ?></a>
                        <a href="<?php echo wp_logout_url(wp_login_url()); ?>" class="btn btn--small  btn--dark-orange float-left btn--with-photo">
