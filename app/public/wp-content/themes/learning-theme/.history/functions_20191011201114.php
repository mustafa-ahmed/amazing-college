...
function makeNotePrivate($data, $postArr)
{
    if ($data['post_type'] == 'note') {
        if (count_user_posts(get_current_user_id(), 'note') > 2 and !$postArr['ID']) {
            die('You have Reached Max numbers Of notes');
        }
...
// wp_insert_post_data  10 number is periorty number and 2 number is  the method will use 2 parameters
add_filter('wp_insert_post_data', 'makeNotePrivate', 10, 2);
add_filter('login_headertitle', 'headerTitle');
add_filter('login_header', 'headerTitle');
